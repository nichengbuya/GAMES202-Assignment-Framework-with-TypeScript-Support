...
function SHEval(fX: number, fY: number, fZ: number, order: number)
{
...
// order 3
function SHEval3(fX: number, fY: number, fZ: number) {
...
// order 4
function SHEval4(fX: number, fY: number, fZ: number)
{
   var fC0,fC1,fS0,fS1,fTmpA,fTmpB,fTmpC;
   var fZ2 = fZ*fZ;
...
// order 5
function SHEval5(fX: number, fY: number, fZ: number)
{
   var fC0,fC1,fS0,fS1,fTmpA,fTmpB,fTmpC;
   var fZ2 = fZ*fZ;
...
// order 6
function SHEval6(fX: number, fY: number, fZ: number)
{
   var fC0,fC1,fS0,fS1,fTmpA,fTmpB,fTmpC;
   var fZ2 = fZ*fZ;
...
// order 7
function SHEval7(fX: number, fY: number, fZ: number)
{
   var fC0,fC1,fS0,fS1,fTmpA,fTmpB,fTmpC;
   var fZ2 = fZ*fZ;
...
// order 8
function SHEval8(fX: number, fY: number, fZ: number)
{
   var fC0,fC1,fS0,fS1,fTmpA,fTmpB,fTmpC;
   var fZ2 = fZ*fZ;
...
// order 9
function SHEval9(fX: number, fY: number, fZ: number)
{
   var fC0,fC1,fS0,fS1,fTmpA,fTmpB,fTmpC;
   var fZ2 = fZ*fZ;
...
// order 10
function SHEval10(fX: number, fY: number, fZ: number)
{
   var fC0,fC1,fS0,fS1,fTmpA,fTmpB,fTmpC;
   var fZ2 = fZ*fZ;
