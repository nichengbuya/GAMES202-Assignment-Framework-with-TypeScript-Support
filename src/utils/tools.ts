...
function getRotationPrecomputeL(precompute_L: any[][], rotationMatrix: ReadonlyMat4){
...
function computeSquareMatrix_3by3(rotationMatrix: any[][]){ // 计算方阵SA(-1) 3*3 
...
function computeSquareMatrix_5by5(rotationMatrix: any[][]){ // 计算方阵SA(-1) 5*5
...
function mat4Matrix2mathMatrix(rotationMatrix: mat4){
...
function getMat3ValueFromRGB(precomputeL: number[][]){
